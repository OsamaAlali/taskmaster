...
public final class Todo implements Model {
  ...
  public static final QueryField TASK_TEAM = field("Todo", "todoTaskTeamId");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String", isRequired = true) String title;
  private final @ModelField(targetType="String") String body;
  private final @ModelField(targetType="String") String state;
  private final @ModelField(targetType="Team") @BelongsTo(targetName = "todoTaskTeamId", type = Team.class) Team taskTeam;
  ...
  private Todo(String id, String title, String body, String state, Team taskTeam) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.state = state;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), todo.getId()) &&
              ...
              ObjectsCompat.equals(getTaskTeam(), todo.getTaskTeam()) &&
